...
@Component({
  ...
  template: `
    <footer
      class="mt-4 flex flex-col md:flex-row items-center justify-between gap-4"
    >
      <div
        class="text-2xl font-medium feedback-container"
        role="alert"
        aria-live="assertive"
      >
